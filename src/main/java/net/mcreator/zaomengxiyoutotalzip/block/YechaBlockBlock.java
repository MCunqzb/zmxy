...
public class YechaBlockBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:yecha_block")
	public static final Block block = null;
	public YechaBlockBlock(ZaomengxiyouModElements instance) {
		super(instance, 924);
	}
