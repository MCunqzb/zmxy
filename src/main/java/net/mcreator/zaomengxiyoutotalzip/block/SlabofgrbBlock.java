...
public class SlabofgrbBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:slabofgrb")
	public static final Block block = null;
	public SlabofgrbBlock(ZaomengxiyouModElements instance) {
		super(instance, 198);
	}
