...
public class GhostkingpalaceslabBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:ghostkingpalaceslab")
	public static final Block block = null;
	public GhostkingpalaceslabBlock(ZaomengxiyouModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ghostkingpalaceslab");
		}
