...
public class BlockofxuehaicsmBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:blockofxuehaicsm")
	public static final Block block = null;
	public BlockofxuehaicsmBlock(ZaomengxiyouModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockofxuehaicsm");
		}
