...
public class GhostKingPalaceBrickfloorBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:ghost_king_palace_brickfloor")
	public static final Block block = null;
	public GhostKingPalaceBrickfloorBlock(ZaomengxiyouModElements instance) {
		super(instance, 235);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ghost_king_palace_brickfloor");
		}
