...
import net.mcreator.zaomengxiyoutotalzip.procedures.BoneashesblockDangShiTiZaiFangKuaiShangXingZouShiProcedure;
...
public class BoneashesblockBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:boneashesblock")
	public static final Block block = null;
	public BoneashesblockBlock(ZaomengxiyouModElements instance) {
		super(instance, 231);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BONE).hardnessAndResistance(1.2f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().speedFactor(0.9f));
			setRegistryName("boneashesblock");
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			BlockState blockstate = world.getBlockState(pos);
			{
				...
				BoneashesblockDangShiTiZaiFangKuaiShangXingZouShiProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
