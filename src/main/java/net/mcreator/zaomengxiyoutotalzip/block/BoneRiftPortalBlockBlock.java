...
public class BoneRiftPortalBlockBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:bone_rift_portal_block")
	public static final Block block = null;
	public BoneRiftPortalBlockBlock(ZaomengxiyouModElements instance) {
		super(instance, 230);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bone_rift_portal_block");
		}
