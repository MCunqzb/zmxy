...
import net.mcreator.zaomengxiyoutotalzip.procedures.BianhuaGengXinYouXiKeProcedure;
...
public class BianhuaBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:bianhua")
	public static final Block block = null;
	public BianhuaBlock(ZaomengxiyouModElements instance) {
		super(instance, 134);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bianhua"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zaomengxiyou:bianhua"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				BianhuaGengXinYouXiKeProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
