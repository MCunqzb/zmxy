...
public class Ghostroomawall1Block extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:ghostroomawall_1")
	public static final Block block = null;
	public Ghostroomawall1Block(ZaomengxiyouModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ghostroomawall_1");
		}
