...
public class NaiheBridgewallBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:naihe_bridgewall")
	public static final Block block = null;
	public NaiheBridgewallBlock(ZaomengxiyouModElements instance) {
		super(instance, 917);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.NETHER_ORE).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
					.speedFactor(0.7f).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("naihe_bridgewall");
		}
