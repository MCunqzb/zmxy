...
public class Ground1Block extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:ground_1")
	public static final Block block = null;
	public Ground1Block(ZaomengxiyouModElements instance) {
		super(instance, 146);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.WET_GRASS).hardnessAndResistance(3f, 1200f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.SHOVEL).setRequiresTool());
			setRegistryName("ground_1");
		}
