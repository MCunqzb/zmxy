...
public class NaiheBridgebricknofloorBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:naihe_bridgebricknofloor")
	public static final Block block = null;
	public NaiheBridgebricknofloorBlock(ZaomengxiyouModElements instance) {
		super(instance, 919);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.NETHER_ORE).hardnessAndResistance(2f, 20f).setLightLevel(s -> 0)
					.jumpFactor(0.9f));
			setRegistryName("naihe_bridgebricknofloor");
		}
