...
public class BlockofflodenpaluceBlock extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:blockofflodenpaluce")
	public static final Block block = null;
	public BlockofflodenpaluceBlock(ZaomengxiyouModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockofflodenpaluce");
		}
