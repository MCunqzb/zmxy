...
public class Csm1Block extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:csm_1")
	public static final Block block = null;
	public Csm1Block(ZaomengxiyouModElements instance) {
		super(instance, 155);
	}
