...
@Mod.EventBusSubscriber(modid = "zaomengxiyou", bus = Bus.MOD, value = Dist.CLIENT)
public class Wangchuangriversky {
    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation("zaomengxiyou", "wangchuanriverworld");
    private static final ResourceLocation SUN_TEXTURES = new ResourceLocation("zaomengxiyou","textures/wangchaungsunuse.png");
    private static final ResourceLocation MOON_PHASES_TEXTURES = new ResourceLocation("zaomengxiyou","textures/wangchuanmoon.png");
    private static final ResourceLocation SKY_TEXTURE = new ResourceLocation("zaomengxiyou", "textures/wangchuansky.png");
