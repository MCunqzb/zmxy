...
public class DonghaicsmStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("donghaicsm"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zaomengxiyou:donghaicsm"), configuredFeature);
		}
	}
	@SubscribeEvent
