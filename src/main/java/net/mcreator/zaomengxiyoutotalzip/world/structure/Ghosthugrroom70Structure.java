...
public class Ghosthugrroom70Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 4000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("zaomengxiyou", "ghosthugeroom70"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("ghosthugrroom_70"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zaomengxiyou:ghosthugrroom_70"), configuredFeature);
		}
	}
	@SubscribeEvent
