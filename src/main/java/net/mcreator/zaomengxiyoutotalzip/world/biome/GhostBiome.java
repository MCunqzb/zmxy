...
import net.mcreator.zaomengxiyoutotalzip.block.Ghostcityblock3Block;
...
public class GhostBiome extends ZaomengxiyouModElements.ModElement {
	public static Biome biome;
	public GhostBiome(ZaomengxiyouModElements instance) {
		super(instance, 552);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-3095565).setWaterColor(-12498860).setWaterFogColor(-10721671)
						.withSkyColor(-3095565).withFoliageColor(-11122076).withGrassColor(-10658439)
						.setAmbientSound(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("zaomengxiyou:ghost")))
						.build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Ghostcityblock1Block.block.getDefaultState(),
								Ghostcityblock3Block.block.getDefaultState(), Ghostcityblock3Block.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("zaomengxiyou:ghost"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("ghost_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("ghost_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
