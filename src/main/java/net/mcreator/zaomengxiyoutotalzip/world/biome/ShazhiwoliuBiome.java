...
public class ShazhiwoliuBiome extends ZaomengxiyouModElements.ModElement {
	public static Biome biome;
	public ShazhiwoliuBiome(ZaomengxiyouModElements instance) {
		super(instance, 401);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-2960129).setWaterColor(-1977601).setWaterFogColor(-11566)
						.withSkyColor(-2960129).withFoliageColor(10387789).withGrassColor(9470285)
						.setAmbientSound(
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.AIR.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.FIRE_CORAL_BLOCK.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("zaomengxiyou:shazhiwoliu"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("shazhiwoliu_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("shazhiwoliu_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("shazhiwoliu_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
