...
public class WangchuanriverbiomesBiome extends ZaomengxiyouModElements.ModElement {
	...
	public WangchuanriverbiomesBiome(ZaomengxiyouModElements instance) {
		super(instance, 862);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-4267821).setWaterColor(-13202559).setWaterFogColor(-15835820)
						.withSkyColor(-4267821).withFoliageColor(-7434610).withGrassColor(-9537167)
						.setAmbientSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("zaomengxiyou:naiheriver")))
						.build();
				...
				event.getRegistry().register(biome.setRegistryName("zaomengxiyou:wangchuanriverbiomes"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("wangchuanriverbiomes_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("wangchuanriverbiomes_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("wangchuanriverbiomes_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
