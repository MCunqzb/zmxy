...
public class PengmowangzhixueBiome extends ZaomengxiyouModElements.ModElement {
	public static Biome biome;
	public PengmowangzhixueBiome(ZaomengxiyouModElements instance) {
		super(instance, 340);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-18731).setWaterColor(-41073).setWaterFogColor(329011)
						.withSkyColor(-18731).withFoliageColor(10387789).withGrassColor(-425856)
						.setAmbientSound(
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.TREE
								.withConfiguration(
										(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.NETHER_BRICK_WALL.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("zaomengxiyou:pengmowangzhixue"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("pengmowangzhixue_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("pengmowangzhixue_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("pengmowangzhixue_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
