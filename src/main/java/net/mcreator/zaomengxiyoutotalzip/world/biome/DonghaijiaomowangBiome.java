...
public class DonghaijiaomowangBiome extends ZaomengxiyouModElements.ModElement {
	public static Biome biome;
	public DonghaijiaomowangBiome(ZaomengxiyouModElements instance) {
		super(instance, 400);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-8998145).setWaterColor(-5648385).setWaterFogColor(329011)
						.withSkyColor(-8998145).withFoliageColor(10387789).withGrassColor(9470285)
						.setAmbientSound(
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.AIR.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.HORN_CORAL_BLOCK.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("zaomengxiyou:donghaijiaomowang"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("donghaijiaomowang_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("donghaijiaomowang_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("donghaijiaomowang_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
