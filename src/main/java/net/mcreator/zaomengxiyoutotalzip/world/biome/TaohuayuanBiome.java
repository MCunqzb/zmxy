...
public class TaohuayuanBiome extends ZaomengxiyouModElements.ModElement {
	public static Biome biome;
	public TaohuayuanBiome(ZaomengxiyouModElements instance) {
		super(instance, 269);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-212749).setWaterColor(-6902529).setWaterFogColor(329011)
						.withSkyColor(-212749).withFoliageColor(-30219).withGrassColor(-15091110)
						.setAmbientSound(
				...
				event.getRegistry().register(biome.setRegistryName("zaomengxiyou:taohuayuan"));
			}
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		BiomeManager.addBiome(BiomeManager.BiomeType.WARM,
				new BiomeManager.BiomeEntry(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), 40));
	}
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("taohuayuan_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("taohuayuan_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("taohuayuan_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
