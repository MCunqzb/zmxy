...
public class HuaguoshanBiome extends ZaomengxiyouModElements.ModElement {
	public static Biome biome;
	public HuaguoshanBiome(ZaomengxiyouModElements instance) {
		super(instance, 267);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10027009).setWaterColor(-13918721).setWaterFogColor(329011)
						.withSkyColor(-10027009).withFoliageColor(-14239720).withGrassColor(-11739586)
						.setAmbientSound(
				...
				event.getRegistry().register(biome.setRegistryName("zaomengxiyou:huaguoshan"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("huaguoshan_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("huaguoshan_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("huaguoshan_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
