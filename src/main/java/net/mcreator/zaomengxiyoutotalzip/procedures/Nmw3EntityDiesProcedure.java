...
import net.mcreator.zaomengxiyoutotalzip.item.MingjeiqixiItem;
import net.mcreator.zaomengxiyoutotalzip.item.JgzItem;
...
public class Nmw3EntityDiesProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ZaomengxiyouMod.LOGGER.warn("Failed to load dependency entity for procedure Nmw3EntityDies!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				ZaomengxiyouMod.LOGGER.warn("Failed to load dependency sourceentity for procedure Nmw3EntityDies!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ZaomengxiyouMod.LOGGER.warn("Failed to load dependency x for procedure Nmw3EntityDies!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ZaomengxiyouMod.LOGGER.warn("Failed to load dependency y for procedure Nmw3EntityDies!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ZaomengxiyouMod.LOGGER.warn("Failed to load dependency z for procedure Nmw3EntityDies!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ZaomengxiyouMod.LOGGER.warn("Failed to load dependency world for procedure Nmw3EntityDies!");
			return;
		}
		...
		}
		{
			...
			for (Entity entityiterator : _entfound) {
				if (entityiterator instanceof PlayerEntity) {
					ItemStack _setstack = new ItemStack(JgzItem.block);
					_setstack.setCount((int) 1);
					ItemHandlerHelper.giveItemToPlayer(((PlayerEntity) entityiterator), _setstack);
				}
				if (entityiterator instanceof PlayerEntity) {
					ItemStack _setstack = new ItemStack(MingjeiqixiItem.block);
					_setstack.setCount((int) 1);
					ItemHandlerHelper.giveItemToPlayer(((PlayerEntity) entityiterator), _setstack);
				}
				if (entityiterator instanceof PlayerEntity) {
					ItemStack _setstack = new ItemStack(Items.BLAZE_ROD);
					_setstack.setCount((int) (1 + ((new Random()).nextInt((int) 5 + 1))));
					ItemHandlerHelper.giveItemToPlayer(((PlayerEntity) entityiterator), _setstack);
				}
			}
		}
		if (sourceentity instanceof ServerPlayerEntity) {
			Advancement _adv = ((MinecraftServer) ((ServerPlayerEntity) sourceentity).server).getAdvancementManager()
					.getAdvancement(new ResourceLocation("zaomengxiyou:achieveniumowang"));
