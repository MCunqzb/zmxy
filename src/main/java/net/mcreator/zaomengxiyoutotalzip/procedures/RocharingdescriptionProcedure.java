...
public class RocharingdescriptionProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				ZaomengxiyouMod.LOGGER.warn("Failed to load dependency itemstack for procedure Rocharingdescription!");
			return;
		}
		if (dependencies.get("tooltip") == null) {
			if (!dependencies.containsKey("tooltip"))
				ZaomengxiyouMod.LOGGER.warn("Failed to load dependency tooltip for procedure Rocharingdescription!");
			return;
		}
		...
		if (((itemstack).getItem() == RocharingItem.block)) {
			tooltips.add((int) 1, new StringTextComponent((new TranslationTextComponent("rocharing.description").getString())));
		}
	}
}
