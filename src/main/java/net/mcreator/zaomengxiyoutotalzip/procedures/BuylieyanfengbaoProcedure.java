...
public class BuylieyanfengbaoProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ZaomengxiyouMod.LOGGER.warn("Failed to load dependency entity for procedure Buylieyanfengbao!");
			return;
		}
		...
		if (((((new Object() {
			...
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("\u00A74\u7075\u9B42\u4E0D\u8DB320"), (false));
			}
		} else if ((!((new Object() {
			public ItemStack getItemStack(int sltid) {
				Entity _ent = entity;
