...
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.XuehaixiehuangRenderer;
...
public class XuehaixiehuangItem extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:xuehaixiehuang")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletxuehaixiehuang").setRegistryName("entitybulletxuehaixiehuang");
	public XuehaixiehuangItem(ZaomengxiyouModElements instance) {
		super(instance, 17);
		FMLJavaModLoadingContext.get().getModEventBus().register(new XuehaixiehuangRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("xuehaixiehuang");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A75\u8FDC\u7A0B\u4F24\u5BB3\uFF1A24\u70B9\uFF0C\u00A75\u547D\u4E2D\u5B9E\u4F53\u5438\u8840\u3002"));
		}
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				double z = entity.getPosZ();
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.5f, 24, 0);
