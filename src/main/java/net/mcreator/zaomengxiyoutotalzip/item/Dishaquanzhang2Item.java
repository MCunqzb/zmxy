...
public class Dishaquanzhang2Item extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:dishaquanzhang_2")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletdishaquanzhang_2").setRegistryName("entitybulletdishaquanzhang_2");
	public Dishaquanzhang2Item(ZaomengxiyouModElements instance) {
		super(instance, 20);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dishaquanzhang2Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("dishaquanzhang_2");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						Dishaquanzhang2DangYuanChengWuPinShiYongShiProcedure.executeProcedure($_dependencies);
					}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			Entity imediatesourceentity = this;
			{
				...
				Dishaquanzhang2DangZiDanJiZhongFangKuaiShiProcedure.executeProcedure($_dependencies);
			}
		}
