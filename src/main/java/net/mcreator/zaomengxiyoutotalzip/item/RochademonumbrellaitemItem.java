...
public class RochademonumbrellaitemItem extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:rochademonumbrellaitem")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletrochademonumbrellaitem").setRegistryName("entitybulletrochademonumbrellaitem");
	public RochademonumbrellaitemItem(ZaomengxiyouModElements instance) {
		super(instance, 1067);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RochademonumbrellaitemRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("rochademonumbrellaitem");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						RochademonumbrellaitemDangYuanChengWuPinShiYongShiProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			Entity imediatesourceentity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				RochademonumbrellaitemDangZiDanJiZhongShengCunShiTiShiProcedure.executeProcedure($_dependencies);
			}
		}
