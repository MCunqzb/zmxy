...
public class BaishaungzhongjiaItem extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:baishaungzhongjia_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zaomengxiyou:baishaungzhongjia_chestplate")
	public static final Item body = null;
	@ObjectHolder("zaomengxiyou:baishaungzhongjia_leggings")
	public static final Item legs = null;
	@ObjectHolder("zaomengxiyou:baishaungzhongjia_boots")
	public static final Item boots = null;
	public BaishaungzhongjiaItem(ZaomengxiyouModElements instance) {
		super(instance, 929);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{2, 7, 14, 2}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(ZaomengxiyouItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedBody = new Modelbaishuangzhongjia().Body;
				armorModel.bipedLeftArm = new Modelbaishuangzhongjia().LeftArm;
				armorModel.bipedRightArm = new Modelbaishuangzhongjia().RightArm;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "zaomengxiyou:textures/baishuangzhongjia.png";
			}
		...
		}.setRegistryName("baishaungzhongjia_chestplate"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(ZaomengxiyouItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				BipedModel armorModel = new BipedModel(1);
				armorModel.bipedLeftLeg = new Modelbaishuangzhongjia().LeftLeg;
				armorModel.bipedRightLeg = new Modelbaishuangzhongjia().RightLeg;
				armorModel.isSneak = living.isSneaking();
				armorModel.isSitting = defaultModel.isSitting;
				armorModel.isChild = living.isChild();
				return armorModel;
		...
		}.setRegistryName("baishaungzhongjia_leggings"));
	}
