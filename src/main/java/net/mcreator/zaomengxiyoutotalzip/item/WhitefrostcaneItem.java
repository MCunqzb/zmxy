...
public class WhitefrostcaneItem extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:whitefrostcane")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletwhitefrostcane").setRegistryName("entitybulletwhitefrostcane");
	public WhitefrostcaneItem(ZaomengxiyouModElements instance) {
		super(instance, 21);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WhitefrostcaneRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ZaomengxiyouItemGroup.tab).maxDamage(100));
			setRegistryName("whitefrostcane");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent(
					"\u00A73\u5BD2\u6C14\u903C\u4EBA\uFF0C\u6BDB\u9AA8\u4FF1\u609A\uFF0C\u72C2\u98D9\u522E\u5730\uFF0C\u4EBA\u9A6C\u4FF1\u60CA\u3002"));
			list.add(new StringTextComponent("\u00A73\u8FDC\u7A0B\u4F24\u5BB3\uFF1A28"));
		}
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			if (slot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Ranged item modifier", (double) 8, AttributeModifier.Operation.ADDITION));
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (BloodevilemperorKeYiShiYongYuanChengWuPinDeTiaoJianProcedure
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						W15tick_coolingProcedure.executeProcedure($_dependencies);
					}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			Entity imediatesourceentity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				WhitefrostcaneDangZiDanJiZhongShengCunShiTiShiProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					WhitefrostcaneDangZiDanJiZhongFangKuaiShiProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
