...
public class GuichengxiangyuancehngItem extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:guichengxiangyuancehng")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletguichengxiangyuancehng").setRegistryName("entitybulletguichengxiangyuancehng");
	public GuichengxiangyuancehngItem(ZaomengxiyouModElements instance) {
		super(instance, 109);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GuichengxiangyuancehngRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("guichengxiangyuancehng");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.3f, 5, 0);
