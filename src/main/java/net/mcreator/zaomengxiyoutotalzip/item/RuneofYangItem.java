...
public class RuneofYangItem extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:runeof_yang")
	public static final Item block = null;
	public RuneofYangItem(ZaomengxiyouModElements instance) {
		super(instance, 858);
	}
