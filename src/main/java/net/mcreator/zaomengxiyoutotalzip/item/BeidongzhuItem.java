...
import net.mcreator.zaomengxiyoutotalzip.procedures.BeidongzhuItemInInventoryTickProcedure;
import net.mcreator.zaomengxiyoutotalzip.itemgroup.ZaomengxiyouItemGroup;
import net.mcreator.zaomengxiyoutotalzip.gui.ShipinglanGuiWindow;
...
public class BeidongzhuItem extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:beidongzhu")
	public static final Item block = null;
	public BeidongzhuItem(ZaomengxiyouModElements instance) {
		super(instance, 106);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof ShipinglanGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(ZaomengxiyouItemGroup.tab).maxStackSize(1).rarity(Rarity.EPIC));
			setRegistryName("beidongzhu");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Beidongzhu");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new ShipinglanGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			double z = entity.getPosZ();
			{
				...
				BeidongzhuItemInInventoryTickProcedure.executeProcedure($_dependencies);
			}
		}
