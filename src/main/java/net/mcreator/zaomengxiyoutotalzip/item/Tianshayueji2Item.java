...
public class Tianshayueji2Item extends ZaomengxiyouModElements.ModElement {
	@ObjectHolder("zaomengxiyou:tianshayueji_2")
	public static final Item block = null;
	public Tianshayueji2Item(ZaomengxiyouModElements instance) {
		super(instance, 12);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent(
						"\u00A73\u7531\u6708\u77F3\u7ECF\u4E09\u5473\u771F\u706B\u7CBE\u70BC\u800C\u6210\uFF0C\u95EA\u8000\u7740\u9EC4\u91D1\u822C\u7684\u5149\u8292\uFF0C\u6B64\u5149\u582A\u6BD4\u7693\u6708\u4E4B\u660E\u3002(\u9020\u68A62)"));
			}
		...
		}.setRegistryName("tianshayueji_2"));
	}
}
