...
public class Ghostpalacetextures {
    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation("zaomengxiyou", "ghostpalace");
    private static final ResourceLocation SUN_TEXTURES = new ResourceLocation("zaomengxiyou","textures/ghostpalacesun.png");
    private static final ResourceLocation MOON_PHASES_TEXTURES = new ResourceLocation("zaomengxiyou","textures/ghostpalacemoon.png");
    private static final ResourceLocation SKY_TEXTURE = new ResourceLocation("zaomengxiyou", "textures/ghostpalcesky.png");
