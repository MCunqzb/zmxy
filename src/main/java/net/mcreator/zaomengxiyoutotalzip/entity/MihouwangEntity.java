...
import net.mcreator.zaomengxiyoutotalzip.item.DishalinjeiItem;
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.MihouwangRenderer;
...
public class MihouwangEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.9f)).build("mihouwang").setRegistryName("mihouwang");
	public MihouwangEntity(ZaomengxiyouModElements instance) {
		super(instance, 28);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MihouwangRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7077633, -14599690, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("mihouwang_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 10;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(DishalinjeiItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Jyyslv1Item.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(DishalinjeiItem.helmet));
			...
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(DishalinjeiItem.helmet));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(MhwdsourceItem.block));
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.enchantment_table.use"));
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				MihouwangOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
