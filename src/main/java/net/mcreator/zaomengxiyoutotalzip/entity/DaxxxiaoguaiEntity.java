...
public class DaxxxiaoguaiEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(1.1f, 1.9f)).build("daxxxiaoguai").setRegistryName("daxxxiaoguai");
	public DaxxxiaoguaiEntity(ZaomengxiyouModElements instance) {
		super(instance, 27);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DaxxxiaoguaiRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -30975, -20222, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("daxxxiaoguai_spawn_egg"));
	}
