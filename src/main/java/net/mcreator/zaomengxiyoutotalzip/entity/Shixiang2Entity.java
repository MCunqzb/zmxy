...
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.Shixiang2Renderer;
...
public class Shixiang2Entity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1.2f, 5f))
					.build("shixiang_2").setRegistryName("shixiang_2");
	public Shixiang2Entity(ZaomengxiyouModElements instance) {
		super(instance, 254);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Shixiang2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("shixiang_2_spawn_egg"));
	}
