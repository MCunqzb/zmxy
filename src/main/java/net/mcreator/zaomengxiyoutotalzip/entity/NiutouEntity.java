...
import net.mcreator.zaomengxiyoutotalzip.procedures.NiutouZiRanShiTiShengChengTiaoJianProcedure;
import net.mcreator.zaomengxiyoutotalzip.itemgroup.ZaomengxiyouItemGroup;
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.NiutouRenderer;
import net.mcreator.zaomengxiyoutotalzip.ZaomengxiyouModElements;

import com.google.common.collect.ImmutableMap;

@ZaomengxiyouModElements.ModElement.Tag
public class NiutouEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("niutou").setRegistryName("niutou");
	public NiutouEntity(ZaomengxiyouModElements instance) {
		super(instance, 65);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NiutouRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6652781, -8776170, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("niutou_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return NiutouZiRanShiTiShengChengTiaoJianProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
				});
	}
