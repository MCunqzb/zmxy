...
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.GhostangerRenderer;
...
public class GhostangerEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f))
					.build("ghostanger").setRegistryName("ghostanger");
	public GhostangerEntity(ZaomengxiyouModElements instance) {
		super(instance, 227);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GhostangerRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -231304, -1, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("ghostanger_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new RandomWalkingGoal(this, 1, 20) {
				@Override
