...
@OnlyIn(Dist.CLIENT)
public class JiaomowangRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(JiaomowangEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeljiaomowang(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/jiaomowang.png");
					}
				};
			});
		}
