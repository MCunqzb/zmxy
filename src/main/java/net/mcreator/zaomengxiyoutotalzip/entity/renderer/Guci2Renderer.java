...
@OnlyIn(Dist.CLIENT)
public class Guci2Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Guci2Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelguci2(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/guci2.png");
					}
				};
			});
		}
