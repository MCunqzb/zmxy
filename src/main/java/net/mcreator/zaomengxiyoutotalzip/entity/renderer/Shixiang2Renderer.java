...
@OnlyIn(Dist.CLIENT)
public class Shixiang2Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Shixiang2Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelshixiang2(), 1.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/shixiang2.png");
					}
				};
			});
		}
	...
	public static class Modelshixiang2 extends EntityModel<Entity> {
		...
		public Modelshixiang2() {
			...
			cube_r7.setTextureOffset(0, 79).addBox(-37.0F, -1.0F, -1.0F, 14.0F, 16.0F, 1.0F, 0.0F, false);
			cube_r7.setTextureOffset(0, 65).addBox(-6.0F, -1.0F, -1.0F, 14.0F, 16.0F, 1.0F, 0.0F, false);
			cube_r7.setTextureOffset(0, 62).addBox(-6.0F, -1.0F, -1.0F, 14.0F, 16.0F, 1.0F, 0.0F, false);
			cube_r8 = new ModelRenderer(this);
			cube_r8.setRotationPoint(-15.0F, -46.0F, -3.0F);
			body.addChild(cube_r8);
			setRotationAngle(cube_r8, -0.3054F, 1.5708F, 0.0F);
			cube_r8.setTextureOffset(0, 18).addBox(-13.0F, 1.0F, -4.0F, 14.0F, 16.0F, 1.0F, 0.0F, false);
			cube_r9 = new ModelRenderer(this);
			cube_r9.setRotationPoint(15.0F, -46.0F, -3.0F);
			body.addChild(cube_r9);
			setRotationAngle(cube_r9, -0.3054F, -1.5708F, 0.0F);
			cube_r9.setTextureOffset(0, 22).addBox(-1.0F, 2.0F, -6.0F, 14.0F, 16.0F, 1.0F, 0.0F, false);
