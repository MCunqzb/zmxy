...
@OnlyIn(Dist.CLIENT)
public class EvilxuanbingRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EvilxuanbingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelxuanbing(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/evilice.png");
					}
				};
			});
		}
