...
@OnlyIn(Dist.CLIENT)
public class GhostgateRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GhostgateEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelGhost_gate(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/ghost_gate.png");
					}
				};
			});
		}
