...
@OnlyIn(Dist.CLIENT)
public class DaxxRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DaxxEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldaxx(), 1f) {
					@Override
