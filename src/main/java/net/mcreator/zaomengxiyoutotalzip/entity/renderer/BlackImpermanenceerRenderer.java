...
@OnlyIn(Dist.CLIENT)
public class BlackImpermanenceerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BlackImpermanenceerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelheiwuchang(), 0.5f) {
					{
