...
@OnlyIn(Dist.CLIENT)
public class Baigujing1Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Baigujing1Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelbaigujing1(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/baigujing1.png");
					}
				};
			});
		}
	...
	public static class Modelbaigujing1 extends EntityModel<Entity> {
		...
		public Modelbaigujing1() {
			...
			head.setTextureOffset(0, 13).addBox(-1.5F, -7.8F, -4.3F, 3.0F, 2.0F, 1.0F, 0.0F, false);
			...
			cube_r2.setTextureOffset(0, 41).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 3.0F, 3.0F, 0.0F, false);
