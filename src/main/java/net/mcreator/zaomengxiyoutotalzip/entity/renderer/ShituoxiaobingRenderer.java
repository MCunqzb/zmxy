...
@OnlyIn(Dist.CLIENT)
public class ShituoxiaobingRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ShituoxiaobingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelshituolingxiaobing(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/shituolingxiaobing.png");
					}
				};
			});
		}
