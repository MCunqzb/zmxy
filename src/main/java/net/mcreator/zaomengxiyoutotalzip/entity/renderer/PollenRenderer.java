...
@OnlyIn(Dist.CLIENT)
public class PollenRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PollenEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpollen(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/pollen.png");
					}
				};
			});
		}
