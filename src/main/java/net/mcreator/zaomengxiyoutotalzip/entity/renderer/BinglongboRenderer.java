...
@OnlyIn(Dist.CLIENT)
public class BinglongboRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BinglongboEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelbinglongbo(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/binglongbo.png");
					}
				};
			});
		}
