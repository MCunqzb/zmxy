...
@OnlyIn(Dist.CLIENT)
public class FivepoisonbeastsRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FivepoisonbeastsEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFive_poison_beasts(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/five_poison_beasts.png");
					}
				};
			});
		}
