...
@OnlyIn(Dist.CLIENT)
public class EvilSunwukongRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EvilSunwukongEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelevilsunwukong(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/evilsunwukong.png");
					}
				};
			});
		}
	...
	public static class Modelevilsunwukong extends EntityModel<Entity> {
		...
		public Modelevilsunwukong() {
			...
			bone.setRotationPoint(-1.0F, 8.0F, -1.0F);
			RightArm.addChild(bone);
			setRotationAngle(bone, -1.789F, 0.0F, 0.0F);
			bone.setTextureOffset(72, 12).addBox(-1.5F, -16.0F, -0.5F, 2.0F, 30.0F, 2.0F, 0.0F, false);
			bone.setTextureOffset(68, 0).addBox(-2.0F, -25.0F, -1.0F, 3.0F, 9.0F, 3.0F, 0.0F, false);
			bone.setTextureOffset(68, 44).addBox(-2.0F, 14.0F, -1.0F, 3.0F, 9.0F, 3.0F, 0.0F, false);
