...
@OnlyIn(Dist.CLIENT)
public class Shixiang1Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Shixiang1Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelshixiang1(), 1.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/shixiang1.png");
					}
				};
			});
		}
