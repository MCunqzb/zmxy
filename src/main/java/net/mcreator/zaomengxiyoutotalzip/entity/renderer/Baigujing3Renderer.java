...
@OnlyIn(Dist.CLIENT)
public class Baigujing3Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Baigujing3Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelbaigujing3(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/baigujing3.png");
					}
				};
			});
		}
	...
	public static class Modelbaigujing3 extends EntityModel<Entity> {
		...
		public Modelbaigujing3() {
			...
			head.setTextureOffset(0, 15).addBox(-1.5F, -7.8F, -4.3F, 3.0F, 2.0F, 1.0F, 0.0F, false);
			...
			cube_r2.setTextureOffset(17, 44).addBox(0.0F, -15.0F, 2.0F, 0.0F, 23.0F, 13.0F, 0.0F, true);
			cube_r3 = new ModelRenderer(this);
			cube_r3.setRotationPoint(2.0F, 0.0F, 0.0F);
			body.addChild(cube_r3);
			setRotationAngle(cube_r3, 0.0F, 0.2618F, 0.0F);
			cube_r3.setTextureOffset(17, 44).addBox(0.0F, -15.0F, 2.0F, 0.0F, 23.0F, 13.0F, 0.0F, false);
			cube_r4 = new ModelRenderer(this);
			cube_r4.setRotationPoint(0.0F, -3.0F, -2.0F);
			body.addChild(cube_r4);
			setRotationAngle(cube_r4, -0.8727F, 0.0F, 0.0F);
			cube_r4.setTextureOffset(0, 41).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 3.0F, 3.0F, 0.0F, false);
			...
			leftarm.setTextureOffset(62, 52).addBox(0.8F, 11.0F, -6.1F, 1.0F, 1.0F, 3.0F, 0.0F, false);
			leftarm.setTextureOffset(72, 50).addBox(-1.0F, 9.0F, -12.1F, 3.0F, 3.0F, 1.0F, 0.0F, false);
			leftarm.setTextureOffset(56, 34).addBox(-1.4F, 8.9F, -21.1F, 1.0F, 1.0F, 9.0F, 0.0F, false);
			leftarm.setTextureOffset(60, 44).addBox(1.5F, 9.9F, -17.1F, 1.0F, 1.0F, 5.0F, 0.0F, false);
			leftarm.setTextureOffset(45, 71).addBox(-0.3F, 11.5F, -20.1F, 1.0F, 1.0F, 8.0F, 0.0F, false);
