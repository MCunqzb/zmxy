...
@OnlyIn(Dist.CLIENT)
public class XiejiangRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(XiejiangEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelxiejiang(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/xiejiang.png");
					}
				};
			});
		}
