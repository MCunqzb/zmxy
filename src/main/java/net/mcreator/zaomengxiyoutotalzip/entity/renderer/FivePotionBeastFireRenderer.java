...
@OnlyIn(Dist.CLIENT)
public class FivePotionBeastFireRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FivePotionBeastFireEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFive_poison_beasts(), 0.4f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/fivepotion_fire.png");
					}
				};
			});
		}
