...
@OnlyIn(Dist.CLIENT)
public class WhitefrostmirrorRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WhitefrostmirrorEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelWhite_frost_mirror(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/white_frost_mirror.png");
					}
				};
			});
		}
