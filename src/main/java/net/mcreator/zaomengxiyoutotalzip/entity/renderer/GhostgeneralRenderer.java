...
@OnlyIn(Dist.CLIENT)
public class GhostgeneralRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GhostgeneralEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelGhost_general(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/ghost_general.png");
					}
				};
			});
		}
