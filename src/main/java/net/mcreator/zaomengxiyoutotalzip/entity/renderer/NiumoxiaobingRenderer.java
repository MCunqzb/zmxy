...
@OnlyIn(Dist.CLIENT)
public class NiumoxiaobingRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NiumoxiaobingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelniumoxiaobing(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/niumoxiaobing.png");
					}
				};
			});
		}
