...
import net.mcreator.zaomengxiyoutotalzip.entity.MobanimationtesterEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class MobanimationtesterRenderer {
	public static class  ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MobanimationtesterEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelmob(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zaomengxiyou:textures/mob.png");
					}
				};
			});
		}
	...
	public static class Modelmob extends EntityModel<Entity> {
