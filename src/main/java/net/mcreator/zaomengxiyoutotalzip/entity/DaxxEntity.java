...
import net.mcreator.zaomengxiyoutotalzip.procedures.DaxxZiRanShiTiShengChengTiaoJianProcedure;
import net.mcreator.zaomengxiyoutotalzip.procedures.DaxxEntityDiesProcedure;
...
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.DaxxRenderer;
...
public class DaxxEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1.1f, 1.9f)).build("daxx").setRegistryName("daxx");
	public DaxxEntity(ZaomengxiyouModElements instance) {
		super(instance, 26);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DaxxRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -420328, -4551384, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("daxx_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.NO_RESTRICTIONS,
				Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return DaxxZiRanShiTiShengChengTiaoJianProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
				});
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(SourcefordaxxItem.block));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(SourcefordaxxItem.block));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				DaxxEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
