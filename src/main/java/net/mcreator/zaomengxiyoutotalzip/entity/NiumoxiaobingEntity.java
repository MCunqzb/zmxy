...
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.NiumoxiaobingRenderer;
import net.mcreator.zaomengxiyoutotalzip.ZaomengxiyouModElements;

@ZaomengxiyouModElements.ModElement.Tag
public class NiumoxiaobingEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.5f)).build("niumoxiaobing").setRegistryName("niumoxiaobing");
	public NiumoxiaobingEntity(ZaomengxiyouModElements instance) {
		super(instance, 48);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NiumoxiaobingRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -10068386, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("niumoxiaobing_spawn_egg"));
	}
