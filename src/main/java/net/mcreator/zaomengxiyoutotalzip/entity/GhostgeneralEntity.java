...
public class GhostgeneralEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ghostgeneral").setRegistryName("ghostgeneral");
	public GhostgeneralEntity(ZaomengxiyouModElements instance) {
		super(instance, 913);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GhostgeneralRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12621117, -13004993, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("ghostgeneral_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 200, 4, 4));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_DAMAGE, 65);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				GhostgeneralDangShiTiGengXinKeShiProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
