...
import net.mcreator.zaomengxiyoutotalzip.procedures.Baigujing3ShiTiSiWangShiProcedure;
import net.mcreator.zaomengxiyoutotalzip.procedures.Baigujing3DangShiTiGengXinKeShiProcedure;
...
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.Baigujing3Renderer;
...
public class Baigujing3Entity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("baigujing_3").setRegistryName("baigujing_3");
	public Baigujing3Entity(ZaomengxiyouModElements instance) {
		super(instance, 220);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Baigujing3Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3787832, -1061941, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("baigujing_3_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.16, false));
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				Baigujing3DangShiTiGengXinKeShiProcedure.executeProcedure($_dependencies);
			}
		}
