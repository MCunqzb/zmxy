...
import net.mcreator.zaomengxiyoutotalzip.procedures.Niumowang1OnEntityTickUpdateProcedure;
import net.mcreator.zaomengxiyoutotalzip.procedures.Niumowang1EntityDiesProcedure;
import net.mcreator.zaomengxiyoutotalzip.itemgroup.ZaomengxiyouItemGroup;
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.Niumowang1Renderer;
...
public class Niumowang1Entity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1.2f, 1.5f)).build("niumowang_1").setRegistryName("niumowang_1");
	public Niumowang1Entity(ZaomengxiyouModElements instance) {
		super(instance, 49);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Niumowang1Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9437184, -11579569, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("niumowang_1_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new RandomWalkingGoal(this, 1.3));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				Niumowang1EntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				Niumowang1OnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
