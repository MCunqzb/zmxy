...
import net.mcreator.zaomengxiyoutotalzip.procedures.BatinxiyouEntityDiesProcedure;
...
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.BatinxiyouRenderer;
...
public class BatinxiyouEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1f)).build("batinxiyou").setRegistryName("batinxiyou");
	public BatinxiyouEntity(ZaomengxiyouModElements instance) {
		super(instance, 31);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BatinxiyouRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092340, -6723841, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("batinxiyou_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 20, 2, 2));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				BatinxiyouEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
