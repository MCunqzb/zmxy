...
import net.mcreator.zaomengxiyoutotalzip.procedures.BirdEntityDiesProcedure;
...
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.BirdRenderer;
...
public class BirdEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1f)).build("bird").setRegistryName("bird");
	public BirdEntity(ZaomengxiyouModElements instance) {
		super(instance, 36);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BirdRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -3381505, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("bird_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(Jyyslv1Item.block));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(PtdxzgItem.block));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				BirdEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
