...
public class WaterspriteEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.7f, 1.8f)).build("watersprite").setRegistryName("watersprite");
	public WaterspriteEntity(ZaomengxiyouModElements instance) {
		super(instance, 881);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WaterspriteRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13535441, -12182181, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("watersprite_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_DAMAGE, 70);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				WaterspriteDangShiTiGengXinKeShiProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
