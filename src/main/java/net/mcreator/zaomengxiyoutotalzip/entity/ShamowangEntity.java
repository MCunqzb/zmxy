...
public class ShamowangEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("shamowang").setRegistryName("shamowang");
	public ShamowangEntity(ZaomengxiyouModElements instance) {
		super(instance, 47);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ShamowangRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16713985, -669035, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("shamowang_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Items.RABBIT));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Items.RABBIT));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(XuehaimojiaItem.body));
		}
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new LookAtGoal(this, XhzEntity.CustomEntity.class, (float) 6));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ShamowangbingmaoItem.block));
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ShamowangOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
