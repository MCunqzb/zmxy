...
public class HeiwuchangEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.8f, 1.8f)).build("heiwuchang").setRegistryName("heiwuchang");
	public HeiwuchangEntity(ZaomengxiyouModElements instance) {
		super(instance, 58);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HeiwuchangRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -6750208, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("heiwuchang_spawn_egg"));
	}
