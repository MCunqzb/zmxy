...
import net.mcreator.zaomengxiyoutotalzip.procedures.Niumowang2OnEntityTickUpdateProcedure;
import net.mcreator.zaomengxiyoutotalzip.procedures.Niumowang2EntityDiesProcedure;
import net.mcreator.zaomengxiyoutotalzip.itemgroup.ZaomengxiyouItemGroup;
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.Niumowang2Renderer;
...
public class Niumowang2Entity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1.8f)).build("niumowang_2").setRegistryName("niumowang_2");
	public Niumowang2Entity(ZaomengxiyouModElements instance) {
		super(instance, 50);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Niumowang2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -15339520, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("niumowang_2_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, AmbientEntity.class, false, false));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				Niumowang2EntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				Niumowang2OnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
