...
import net.mcreator.zaomengxiyoutotalzip.procedures.Baigujing2ShiTiSiWangShiProcedure;
import net.mcreator.zaomengxiyoutotalzip.procedures.Baigujing2DangShiTiGengXinKeShiProcedure;
...
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.Baigujing2Renderer;
...
public class Baigujing2Entity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("baigujing_2").setRegistryName("baigujing_2");
	public Baigujing2Entity(ZaomengxiyouModElements instance) {
		super(instance, 219);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Baigujing2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6012742, -207660, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("baigujing_2_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 18);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.bone_block.break"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				Baigujing2ShiTiSiWangShiProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				Baigujing2DangShiTiGengXinKeShiProcedure.executeProcedure($_dependencies);
			}
		}
