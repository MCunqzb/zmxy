...
import net.mcreator.zaomengxiyoutotalzip.item.JiachuanbaojianItem;
import net.mcreator.zaomengxiyoutotalzip.item.BianfhushixianghexingItem;
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.BianfushikuRenderer;
...
public class BianfushikuEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1.5f, 2.5f)).build("bianfushiku").setRegistryName("bianfushiku");
	public BianfushikuEntity(ZaomengxiyouModElements instance) {
		super(instance, 30);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BianfushikuRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10073012, -8165529, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("bianfushiku_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("zaomengxiyou:bianfuku").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 15;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Jyyslv1Item.block));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Jyyslv1Item.block));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(JiachuanbaojianItem.block));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(JiachuanshouhuanItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(JiachuanbaojianItem.block));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BianfhushixianghexingItem.block));
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BianfushikuOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
