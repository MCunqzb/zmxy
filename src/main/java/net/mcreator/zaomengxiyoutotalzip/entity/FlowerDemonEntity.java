...
import net.mcreator.zaomengxiyoutotalzip.item.RedpetalsItem;
import net.mcreator.zaomengxiyoutotalzip.item.PurplepetalsItem;
import net.mcreator.zaomengxiyoutotalzip.item.HuoluoboItem;
import net.mcreator.zaomengxiyoutotalzip.item.GreenpetalsItem;
import net.mcreator.zaomengxiyoutotalzip.entity.renderer.FlowerDemonRenderer;
...
public class FlowerDemonEntity extends ZaomengxiyouModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("flower_demon").setRegistryName("flower_demon");
	public FlowerDemonEntity(ZaomengxiyouModElements instance) {
		super(instance, 910);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FlowerDemonRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -967722, -6424998, new Item.Properties().group(ZaomengxiyouItemGroup.tab))
				.setRegistryName("flower_demon_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 150, 4, 4));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.NO_RESTRICTIONS,
				Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return FlowerDemonZiRanShiTiShengChengTiaoJianProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
				});
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(RedpetalsItem.block));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(GreenpetalsItem.block));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(PurplepetalsItem.block));
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				FlowerDemonDangShiTiGengXinKeShiProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FlowerDemonDangWanJiaYuGaiShiTiXiangZhuangShiProcedure.executeProcedure($_dependencies);
			}
		}
